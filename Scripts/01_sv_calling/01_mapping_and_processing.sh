#!/bin/bash
# Script: 01_mapping_and_processing.sh
# Description: Long-read mapping using Winnowmap, BAM processing with SAMtools, and coverage calculation.
# Paper Reference: "Long-read sequencing reveals a pan-African structural variation landscape..."
# Tools used: Winnowmap v2.03, SAMtools v1.7, Pandepth v2.25
...
# Step 4: Calculate Coverage using Pandepth 
echo "Step 4: Calculating coverage with Pandepth..."
${PANDEPTH} -i ${OUTPUT_DIR}/${OUT_PREFIX}.sorted.bam -o ${OUTPUT_DIR}/${OUT_PREFIX}_depth
